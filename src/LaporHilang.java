...
public class LaporHilang extends base {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Tunggu lostButton bisa diklik dan klik
        AndroidElement lostButton = (AndroidElement) wait.until(
            ExpectedConditions.elementToBeClickable(
                By.xpath("//android.widget.CompoundButton[@resource-id='com.example.mobilebalikin:id/lostButton']")));
        lostButton.click();
        ...
        // Tunggu kembali ke halaman utama (tunggu sampai tombol "Hilang" muncul)
        AndroidElement hilangTab = (AndroidElement) wait.until(
            ExpectedConditions.elementToBeClickable(
                MobileBy.AndroidUIAutomator("new UiSelector().description(\"Hilang\")")));
        hilangTab.click();
